...
import dravitphoto from "../assets/images/dravit_photo.jpeg";
C:\Users\rajkumar.s\Desktop\dravit\DRAVIT DETAILS\porfolio\project\src\assets\images\dravit_photo.jpeg
          ...
          <div className="mt-10 lg:mt-0">
            <img
              className="rounded-lg shadow-xl"
               src={dravitphoto} style={{ maxWidth: "100%" }}  alt="dravitphoto" 
